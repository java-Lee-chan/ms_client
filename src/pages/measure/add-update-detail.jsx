  ...
  handleSubmit = (event) => {
    ...
    this.props.form.validateFields(async (err, values) => {
      if(!err){
        ...
        measure.next_time = values.next_time.format('YYYY/MM/DD');
        // measure.duration = parseInt(values.duration);
          ...
          <Item label='检定周期:'>
            {
              getFieldDecorator('duration', {
                initialValue: isUpdate? measure.duration.toString(): (isDetail? measureDetail.duration.toString(): ''),
              })(
          ...
          <Item label='有效期至:'>
            {
              getFieldDecorator('next_time', {
                initialValue: isUpdate? moment(measure.next_time, 'YYYY/MM/DD'): (isDetail? moment(measureDetail.next_time, 'YYYY/MM/DD'): null),
              })(<DatePicker disabled/>)
            }
          </Item>
          <Item label='ABC管理:'>
